  ...
  it: {
    ...
    rsvp: {
      ...
      transportOptions: [
        ...
        { value: "unsure",label: "Non lo so ancora", sublabel: "Lo decido più avanti" },
      ],
      addGuestLabel: "+ Aggiungi un'altra persona",
      removeGuestLabel: "Rimuovi",
      ageGroupLabel: "Fascia d'età",
      ageGroupOptions: [
        { value: "baby",  label: "Bimbo",    sublabel: "0–2 anni · Viene, è piccolo, è adorabile" },
        { value: "kid",   label: "Bambino",  sublabel: "2–12 anni · Spazio giochi, animazione e menu dedicato" },
        { value: "adult", label: "Adulto",   sublabel: "12+ anni · Tavolo principale, menu completo" },
      ],
      babySeatingLabel: "Dove preferisci che stia il bimbo?",
      babySeatingOptions: [
        { value: "table", label: "Con me al tavolo", sublabel: "Aggiungiamo una sedia extra e un seggiolino" },
        { value: "nanny", label: "Nello spazio bimbi", sublabel: "Ci pensiamo noi — c'è una tata dedicata" },
      ],
      messageLabel: "Note",
      messagePlaceholder: "Lascia un messaggio per la sala 😊",
      dietaryOtherValue: "Allergie / intolleranze / altro (specifica)",
      submitLabel: "Invia",
  ...
  en: {
    ...
    rsvp: {
      ...
      transportOptions: [
        ...
        { value: "unsure",label: "Not sure yet",sublabel: "I'll decide later" },
      ],
      addGuestLabel: "+ Add another person",
      removeGuestLabel: "Remove",
      ageGroupLabel: "Age group",
      ageGroupOptions: [
        { value: "baby",  label: "Baby",  sublabel: "0–2 · Just here to be cute" },
        { value: "kid",   label: "Kid",   sublabel: "2–12 · Play space, activities & special menu" },
        { value: "adult", label: "Adult", sublabel: "12+ · Main tables, full menu" },
      ],
      babySeatingLabel: "Where would you like baby to be?",
      babySeatingOptions: [
        { value: "table", label: "At the table with me", sublabel: "We'll add an extra chair and a highchair" },
        { value: "nanny", label: "In the baby space",    sublabel: "We'll take care of them — there's a dedicated nanny" },
      ],
      messageLabel: "Notes",
      messagePlaceholder: "Leave a message for the room 😊",
      dietaryOtherValue: "Allergies / intolerances / other (specify)",
      submitLabel: "Send",
