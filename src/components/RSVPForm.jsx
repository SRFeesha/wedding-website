...
export default function RSVPForm({ copy }) {
  ...
  return (
    <section id="rsvp" className="bg-canvas-100 px-5 pt-12 sm:px-8">
      <div
        className="mx-auto max-w-2xl rounded-t-3xl bg-canvas-50 px-7 pt-10 pb-10 sm:px-12 sm:pt-12 sm:pb-12"
